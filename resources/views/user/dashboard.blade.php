                        ...
                        <div class="card bg-white shadow-sm">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="row g-3 g-md-4">
                                        ...
                                        <a href="{{ route('user.questions.index') }}" class="text-decoration-none">
                                            <div class="card h-100 border-0 shadow-sm hover-card">
                                                <div class="card-body text-center py-4">
                                                    <i class="bi bi-collection text-primary mb-3"
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="{{ route('user.ranking') }}" class="text-decoration-none">
                                            <div class="card h-100 border-0 shadow-sm hover-card">
                                                <div class="card-body text-center py-4">
                                                    <i class="bi bi-trophy text-warning mb-3" style="font-size: 3rem;"></i>
                                                    <h5 class="text-dark">Ver Ranking</h5>
                                                    <p class="text-muted small mb-0">Ranking completo de participantes</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="{{ route('user.export-emails') }}" class="text-decoration-none">
                                            <div class="card h-100 border-0 shadow-sm hover-card">
                                                <div class="card-body text-center py-4">
                                                    <i class="bi bi-file-earmark-spreadsheet text-info mb-3"
                                                        style="font-size: 3rem;"></i>
                                                    <h5 class="text-dark">Exportar Emails</h5>
                                                    <p class="text-muted small mb-0">Baixar CSV com todos os emails</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
