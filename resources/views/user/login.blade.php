        ...
        <div class="col-md-6">
            <div class="card shadow-lg border-0 rounded-lg">
                <div class="card-header bg-dark text-white text-center py-4">
                    <h3 class="mb-0 font-weight-bold">Área Administrativa</h3>
                    <p class="mb-0 opacity-75">Acesso restrito a administradores</p>
                </div>
                ...
                <div class="card-footer bg-light text-center py-3">
                    <p class="mb-0">Não tem conta? <a href="{{ route('user.register') }}" class="text-dark fw-bold text-decoration-none">Criar Conta</a></p>
                </div>
            </div>
        </div>
    </div>
